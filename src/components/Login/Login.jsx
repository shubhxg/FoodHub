...
export default function Login() {
  ...
  return (
    <div className="md:min-h-screen md:flex md:items-center md:justify-center bg-gray-100 min-w-screen">
      <div className="bg-white p-8 rounded-xl shadow-md w-auto md:flex md:items-center justify-start gap-8">
        <div>
          <figure>
            <img
              className="md:w-auto md:max-h-2/6 object-cover rounded-xl md:block hidden"
